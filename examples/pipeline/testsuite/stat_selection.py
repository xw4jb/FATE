...
from fate_client.pipeline.components.fate import Intersection, Statistics, HeteroFeatureSelection, HeteroFeatureBinning
...
def main(config="./config.yaml", namespace=""):
    ...
    statistics_0 = Statistics(name="statistics_0", train_data=intersection_0.outputs["output_data"],
                              metrics=["mean", "max"])
    ...
    selection_0 = HeteroFeatureSelection(name="selection_0", train_data=intersection_0.outputs["output_data"],
                                         ...
                                         statistic_param={"metrics": ["mean", "max"]})
    ...
    print(pipeline.deploy([intersection_0, selection_0]))
