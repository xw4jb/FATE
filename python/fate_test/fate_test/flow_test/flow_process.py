...
def run_fate_flow_test(config_json):
    ...
    train, train_count = train_job(data_base_dir, guest_party_id, host_party_id, arbiter_party_id, train_conf_path,
                                   train_dsl_path, server_url, component_name, metric_output_path, model_output_path,
                                   constant_auc)
    if not train:
    ...
    predict, predict_count = predict_job(data_base_dir, guest_party_id, host_party_id, arbiter_party_id,
                                         predict_conf_path,
